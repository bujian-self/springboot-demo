...
public class SwaggerConfig implements CommandLineRunner {
    ...
    public void run(String... args) {
        System.out.println(
                "  ____                                            _          _  __      _  _   _ \n" +
                " / ___|_      ____ _  __ _  __ _  ___ _ __       | | ___ __ (_)/ _| ___| || | (_)\n" +
                " \\___ \\ \\ /\\ / / _` |/ _` |/ _` |/ _ \\ '__|      | |/ / '_ \\| | |_ / _ \\ || |_| |\n" +
                "  ___) \\ V  V / (_| | (_| | (_| |  __/ |         |   <| | | | |  _|  __/__   _| |\n" +
                " |____/ \\_/\\_/ \\__,_|\\__, |\\__, |\\___|_|         |_|\\_\\_| |_|_|_|  \\___|  |_|_/ |\n" +
                "                     |___/ |___/                                            |__/ \n" +
                "version: Swagger-2.9.2,knife4j-2.0.7,\tFont Name: Ivrit\n" +
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .enable(enabled).apiInfo(
                        new ApiInfoBuilder()
                                ...
                                //描述
                                .description("knife4j API 描述")
                                //创建人
                                .contact(new Contact("不见", "https://github.com/bujian-self", "1084508243@qq.com"))
                                //版本号
                                .version("1.0")
                                .build()
                ).groupName("1.0 版本")
